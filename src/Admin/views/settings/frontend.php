                 ...
                 <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        ...
                        <div class="form-group">
                         ...
                         <input type="text" class="form-control" placeholder="txt,png,jpeg,gif,jpg,psd" value="<?php echo get_option('__wpdm_allowed_file_types_frontend',''); ?>" name="__wpdm_allowed_file_types_frontend" />
                         </div>
