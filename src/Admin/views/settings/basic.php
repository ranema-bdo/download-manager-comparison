...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <p>
            <em><?php echo __('If you like, you may enter custom structures for your wpdm category and package URLs here. For example, using "<b>packages</b>" as your category base would make your category links like http://example.org/<b>packages</b>/category-slug/. If you leave these blank the defaults will be used.'); ?>
                <br/>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="__wpdm_purl_base"
                   value="<?php echo get_option('__wpdm_purl_base', 'download'); ?>"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group"
             id="aps" <?php echo get_option('__wpdm_has_archive') == '1' ? '' : 'style="display:none;"' ?>>
            <label><?php _e("Archive Page Slug", "download-manager"); ?></label>
            <input type="text" class="form-control" name="__wpdm_archive_page_slug"
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <label><input type="checkbox" <?php checked(get_option('__wpdm_flat_download_url'), 1); ?>
                          name="__wpdm_flat_download_url"
                          value="1"> <?php _e("Activate flat download url", "download-manager"); ?> <span
                        class="label label-info">beta</span> </label><br/>
        ...
        <div class="form-group">
            ...
            <label><input style="margin-right: 5px"
                          ...
                          name="__wpdm_open_in_browser"><?php _e("Open in new window", "download-manager"); ?></label><br/>
            <em><?php _e("Try to ppen in new window/tab instead when someone clicks on download link", "download-manager"); ?></em>
            <br/>
        </div>
        <hr/>
        <div class="form-group">
