...
<div class="wcheader" style="background: #fff;border-bottom: 1px solid #ddd">
    ...
    <div class="container-fluid" style="margin-top: 10px;max-width: 1200px">
        <div class="row">
            ...
            <div class="col-md-12 lead text-center">Install the following add-ons to make your WordPress Download Manager more awesome<br/><br/></div>
            <div class="col-md-4">
                    ...
                    <div style="overflow: hidden" class="panel-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p>WordPress Download Manager shortcode helper for the block editor.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="overflow: hidden" class="panel-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p>Sell digital product securely, onetime or recurring payment.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    <div style="overflow: hidden" class="panel-body">
                        <div class="media">
                            <div class="media-body">
                                <b><a target="_blank" href="https://www.wpdownloadmanager.com/download/wpdm-extended-short-codes/">WPDM Extended Short-codes</a></b>
                                <p>WPDM Extended Short-codes add-on will give you better experience in using WordPress</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 lead">
                <hr/>
                <h3>What's New?</h3>
                What new with WordPress Download Manager Pro v6.0.x:
                <hr/>
            </div>
