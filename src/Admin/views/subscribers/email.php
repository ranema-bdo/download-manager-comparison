...
?>
<form id="subsform" method="post" action="edit.php?post_type=wpdmpro&page=wpdm-subscribers&task=delete&lockOption=email">
    <?php wp_nonce_field(WPDM_PRI_NONCE, '__wpdmdemail'); ?>
    <div class="panel panel-default">
    <table id="subtbl" cellspacing="0" class="table table-striped  bg-white">
        <thead>
        <tr>
        ...
        $page_links = wpdm_paginate_links($total, $limit,  $cp, 'paged', ['base' => add_query_arg( 'paged', '%#%' )]);
