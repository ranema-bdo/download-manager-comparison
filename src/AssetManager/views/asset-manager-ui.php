...
?>
    <style>
        ...
        .dir-row.active .action-btns-ctrl,
        .file-row.active .action-btns-ctrl {
...
<div class="w3eden" id="mainfmarea">
    ...
    <div id="mainfmc" class="panel panel-default wpdm-file-manager-panel" style="display: none;">
        <div class="panel-body">
            <div id="wpdmam-tools-btn" class="media well-sm well-file" style="margin: 0;padding: 0">
                <div class="pull-right">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-simple btn-sm" data-toggle="modal" data-target="#newfile"><i class="far fa-file"></i> <?= esc_attr__( 'New File', WPDM_TEXT_DOMAIN ); ?></button>
                    ...
                    <button class="btn btn-info btn-simple btn-sm ttip" data-placement="bottom" id="btn-featured-assets" title="Featured Assets"><i class="fas fa-star"></i></button>
                    <button class="btn btn-info btn-simple btn-sm ttip" data-placement="bottom" id="btn-paste" disabled="disabled" title="Paste"><i class="fa fa-clipboard"></i></button>
                    <button class="btn btn-simple btn-sm ttip" data-placement="bottom" title="Full Screen"  onclick="openFullscreen('mainfmarea');"><i class="fa fa-expand-arrows-alt"></i></button>
                    <a class="btn btn-simple btn-danger btn-sm ttip" data-placement="bottom" title="Close" href="<?= admin_url('edit.php?post_type=wpdmpro') ?>"><i class="fa fa-times"></i></a>
                </div>
        ...
        <div class="panel-heading" style="border-radius: 0;border-top: 1px solid #dddddd">
            <div id="ldn" style="float:right;font-size: 9pt;margin-top: 10px;display: none" class="text-danger"><i class="fa fa-sun fa-spin"></i> <?= esc_attr__( 'Loading', WPDM_TEXT_DOMAIN ); ?>...</div>
                ...
                <div class="col-md-3 wpdm-dir-locator">
                    <div data-simplebar ss-container>
                        <ul class="wpdmfm-folder-tree" id="wpdmfm-folder-tree">
                            <li data-path="" id="<?php echo md5('home'); ?>" class="expand-dir"><i class="fa fa-hdd color-purple"></i> <a class="explore-dir" href="#" data-path=""> <?= esc_attr__( 'Home', WPDM_TEXT_DOMAIN ); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-9 wpdm-file-locator" id="filewin">
                    <ul id="contextMenu" class="dropdown-menu" role="menu" style="display:none;padding: 10px 0 0" >
                        <li><a tabindex="-1" href="#" data-action="copy"><i class="fa fa-copy"></i> <?= esc_attr__( 'Copy', WPDM_TEXT_DOMAIN ); ?></a></li>
                        <li><a tabindex="-1" href="#" data-action="cut"><i class="fa fa-cut"></i> <?= esc_attr__( 'Cut', WPDM_TEXT_DOMAIN ); ?></a></li>
                        <li class="hide-on-dir"><a tabindex="-1" href="#" data-action="download"><i class="far fa-arrow-alt-circle-down"></i> <?= esc_attr__( 'Download', WPDM_TEXT_DOMAIN ); ?></a></li>
                        <li><a tabindex="-1" href="#" data-action="settings"><i class="fa fa-cog"></i> <?= esc_attr__( 'Settings', WPDM_TEXT_DOMAIN ); ?></a></li>
                        <li class="divider"></li>
                        <li><a tabindex="-1" href="#" data-action="delete"><i class="fas fa-trash"></i> <?= esc_attr__( 'Delete', WPDM_TEXT_DOMAIN ); ?></a></li>
                    </ul>
                ...
                <div class="col-md-3" id="cogwin" style="display: none;">
                    <div class="panel panel-default blockui" style="left:0;width: 100%;height: 900px;border: 0;border-left: 1px solid #eee;border-radius: 0;position: absolute;">
                        <div class="panel-heading" style="border-radius: 0;border-top: 0 !important;">
                            <div  class="pull-right">
                            <a href="#" id="close-settings"><i class="fas fa-times-circle text-muted"></i></a>
                            </div>
                            <?= esc_attr__( 'Asset Settings', WPDM_TEXT_DOMAIN ); ?>
                        </div>
                        <div class="panel-body" id="__asset_settings">
                            ...
                            <div class="form-group">
                                <div class="media" style="border:1px solid #e8e8e8;border-radius: 3px;padding: 10px;">
                                    <div class="pull-right">
                                        <button class="btn btn-xs btn-secondary btn-rename" type="button" title="<?= esc_attr__( 'Rename', WPDM_TEXT_DOMAIN ); ?>" data-toggle="modal" data-target="#rename"><i class="fas fa-i-cursor"></i> <?= esc_attr__( 'Rename', WPDM_TEXT_DOMAIN ); ?></button>
                                    </div>
                                    <div class="media-body">
                                        &nbsp;{{ asset.name }}
                                    </div>
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <strong class="modal-title" id="myModalLabel"><?= esc_attr__( 'Rename', WPDM_TEXT_DOMAIN ); ?></strong>
                                            </div>
                                            <div id="upload" class="modal-body">
                                                <input type="text" v-bind:value="asset.name" placeholder="<?= esc_attr__( 'New Name', WPDM_TEXT_DOMAIN ); ?>" id="newname" class="form-control form-control-lg" style="margin: 0px;border: 1px dashed #d4d4d4;">
                                            </div>
                                            <div class="modal-footer text-right">
                                                <button type="button" id="renamenow" class="btn btn-info"  :data-assetid="asset.ID" :data-oldname="asset.name" :data-path="asset.path"><?= esc_attr__( 'Rename', WPDM_TEXT_DOMAIN ); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <ul class="nav nav-tabs" id="__file_settings_tabs" role="tablist" style="margin-left: -15px;padding-left: 15px;margin-right: -15px;border-bottom: 1px solid #e8e8e8;">
                                    ...
                                    <li role="presentation"><a href="#permissions" aria-controls="permissions" role="tab" data-toggle="tab"><?= esc_attr__( 'Permissions', WPDM_TEXT_DOMAIN ); ?></a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="share">
                                        ...
                                        <div class="form-group" style="margin-top: 15px">
                                            <button type="button" class="btn btn-primary btn-block" data-target="#sharelink" data-toggle="modal"><i class="fa fa-link"></i> <?php echo __( "Generate sharable link", "download-manager" ); ?></button>
                                        </div>

                                        <div id="__asset_links">
                                            <div class="asset-link input-group-lg input-group" v-bind:id="'asset-link-' + link.ID"  v-for="link in asset.links">
                                                <div class="input-group-addon"><i class="fa fa-link"></i></div>
                                                <input type="text" class="form-control" readonly="readonly" v-bind:value="link.url" />
                                                <div class="input-group-btn">
                                                    <button type="button" v-bind:data-linkid="link.ID" data-toggle="modal" data-target="#__link_settings" class="btn btn-simple btn-edit-link"><i class="fa fa-wrench"></i></button>
                                                    <button type="button" v-bind:data-linkid="link.ID" class="btn btn-simple btn-delete-link"><i class="fa fa-trash color-danger"></i></button>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="modal fade" tabindex="-1" role="dialog" id="sharelink">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close pull-right" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button>
                                                        <strong class="modal-title" id="myModalLabel"><?php echo __( "Create new sharable link", "download-manager" ); ?></strong>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form id="sharelink_form" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
                                                            <?php wp_nonce_field(WPDMAM_NONCE_KEY, '__wpdm_newsharelink'); ?>
                                                            <input type="hidden" name="action" value="wpdm_newsharelink" />
                                                            <input type="hidden" name="asset" v-bind:value="asset.ID" id="asset_ID" />
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body allow-roles">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <label><input type="checkbox" name="access[roles][]" value="guest" /> <?php echo __( "All Visitors" , "download-manager" ); ?></label>
                                                                        </div>
                                                                        ...
                                                                        foreach( $roles as $role => $name ) {
                                                                            ?>
                                                                            <div class="col-md-3"><label><input type="checkbox" name="access[roles][]" value="<?php echo $role; ?>" /> <?php echo $name; ?></label></div>
                                                                        <?php } ?>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                if(is_plugin_active('wpdm-custom-access-level/wpdm-custom-access-level.php')){ ?>
                                                                    ...
                                                                    <div class="panel-footer"><input id="maname" placeholder="<?= esc_attr__( 'Start typing to search members', WPDM_TEXT_DOMAIN ); ?>..." style="width: 100%" type="text" class="form-control"></div>
                                                            ...
                                                            <div class="text-right">
                                                                <button type="submit" id="create_sharelink" class="btn btn-info"><?= esc_attr__( 'Create', WPDM_TEXT_DOMAIN ); ?></button>
                                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="comments">
                                        <div class="panel panel-default" id="newcomment_panel" style="margin: 10px 0;">

                                            <textarea class="form-control" style="border: 0;box-shadow: none !important;" id="newcomment"></textarea>
                                            <div class="panel-footer text-right" style="padding: 5px;"><button id="addcomment" :data-assetid="asset.ID" type="button" class="btn btn-sm btn-info"><?= esc_attr__( 'Add Comment', WPDM_TEXT_DOMAIN ); ?></button></div>
                                        </div>

                                        <div id="__asset_comments">
                                            <div class="asset-comment"  v-for="comment in asset.comments">
                                                <div class="media">
                                                    <div class="pull-left" v-html="comment.avatar"></div>
                                                    <div class="media-body">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="permissions">
                                        <br/>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" style="border-top: 0 !important;">
                                                <?= esc_attr__( 'File Permissions', WPDM_TEXT_DOMAIN ); ?>
                                            </div>
                                            <table class="table table-stripped chmodtbl text-center" id="chmodtbl" style="margin: 0">
                                                <tbody><tr>
                                                    <th class="text-left"><b>Mode</b></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" class="_pru __prm" v-bind:checked="asset.filemods.user.read" name="ur" value="4" onclick="wpdmam_calcperm()"></td>
                                                    <td><input type="checkbox" class="_prg __prm" v-bind:checked="asset.filemods.group.read" name="gr" value="4" onclick="wpdmam_calcperm()"></td>
                                                    <td><input type="checkbox" class="_prw __prm" v-bind:checked="asset.filemods.world.read" name="wr" value="4" onclick="wpdmam_calcperm()"></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left">Write</td>
                                                    <td><input type="checkbox" class="_pru __prm" v-bind:checked="asset.filemods.user.write" name="uw" value="2" onclick="wpdmam_calcperm()"></td>
                                                    <td><input type="checkbox" class="_prg __prm" v-bind:checked="asset.filemods.group.write" name="gw" value="2" onclick="wpdmam_calcperm()"></td>
                                                    <td><input type="checkbox" class="_prw __prm" v-bind:checked="asset.filemods.world.write" name="ww" value="2" onclick="wpdmam_calcperm()"></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left">Execute</td>
                                                    <td><input type="checkbox" class="_pru __prm" v-bind:checked="asset.filemods.user.execute" name="ux" value="1" onclick="wpdmam_calcperm()"></td>
                                                    <td><input type="checkbox" class="_prg __prm" v-bind:checked="asset.filemods.group.execute" name="gx" value="1" onclick="wpdmam_calcperm()"></td>
                                                    <td><input type="checkbox" class="_prw __prm" v-bind:checked="asset.filemods.world.execute" name="wx" value="1" onclick="wpdmam_calcperm()"></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left">Permission</td>
                                                    <td id="pm-u" class="text-primary">{{ asset.permissions.user }}</td>
                                                    <td id="pm-g" class="text-primary">{{ asset.permissions.group }}</td>
                                                    <td id="pm-w" class="text-primary">{{ asset.permissions.world }}</td>
                                                </tr>
                                                </tbody></table>
                                            <div class="panel-footer">
                                                <button type="button" id="wpdmam-cfp" onclick="updatePerms()" class="btn btn-block btn-primary"><?= esc_attr__( 'Change Permissions', WPDM_TEXT_DOMAIN ); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div id="dirTPL" style="display: none">
        <div class="dir-row item-row" id="row_{{id}}" data-id="{{id}}">
            <div class="row panel-file panel-folder">

                <div class="col-md-8 file-info-area"  data-id="{{id}}">
    ...
    <div id="fileTPL" style="display: none">
            ...
            <div class="file-row item-row" id="row_{{id}}" data-id="{{id}}">
                <div class="row panel-file file-tpl">
                    ...
                    <div class="col-md-4 text-right">
                        <div class="action-btns" id="action-btns-{{id}}">
                            <button data-id="{{id}}" class="btn btn-xs btn-simple btn-success btn-feature" type="button" title="Featured" data-oldname="{{item}}" data-path="{{path}}"><i class="{{star}} fa-star"></i></button>
                            <button data-id="{{id}}" class="btn btn-xs btn-simple btn-primary btn-settings" type="button" title="Settings" data-oldname="{{item}}" data-path="{{path}}"><i class="far fa-sun"></i></button>
                            <button data-id="{{id}}" class="btn btn-xs btn-simple btn-warning btn-unzip {{ext}}"  type="button" title="UnZip" data-dirname="{{item}}" data-dirpath="{{path}}"><i class="fas fa-box-open"></i></button>
                            <button data-id="{{id}}" class="btn btn-xs btn-simple btn-cut" data-item="{{item}}" title="Cut" type="button"><i class="fa fa-cut"></i></button>
                            <button data-id="{{id}}" class="btn btn-xs btn-simple btn-copy" data-item="{{item}}" title="Copy" type="button"><i class="fa fa-copy"></i></button>
                            ...
                            <button data-id="{{id}}" class="btn btn-xs btn-simple btn-danger btn-delete" title="Delete" type="button" data-path="{{path}}"><i class="fas fa-trash"></i></button>
                        </div>
                        <a href="#" data-id="{{id}}" class="text-muted pull-right action-btns-ctrl" data-target="#action-btns-{{id}}"><i class="fas fa-ellipsis-v"></i></a>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" id="newfol">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close pull-right" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button>
                    <strong class="modal-title" id="myModalLabel"><?= esc_attr__( 'New Folder', WPDM_TEXT_DOMAIN ); ?></strong>
                </div>
                <div id="upload" class="modal-body">
                    <input type="text" placeholder="Folder Name" id="folname" class="form-control form-control-lg" style="margin: 0">
                </div>
                <div class="modal-footer text-right">
                    <button type="button" id="createfol" class="btn btn-info"><?= esc_attr__( 'Create Folder', WPDM_TEXT_DOMAIN ); ?></button>
                    <div style="float:left;display: none;" id="fcd" class="text-success"><i class="fa fa-check-circle"></i> <?= esc_attr__( 'Folder Created', WPDM_TEXT_DOMAIN ); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" id="newfile">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close pull-right" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button>
                    <strong class="modal-title" id="myModalLabel"><?= esc_attr__( 'New File', WPDM_TEXT_DOMAIN ); ?></strong>
                </div>
                <div id="upload" class="modal-body">
                    <input type="text" placeholder="File Name" id="filename" class="form-control form-control-lg" style="margin: 0">
                </div>
                <div class="modal-footer text-right">
                    <button type="button" id="createfile" class="btn btn-info"><?= esc_attr__( 'Create File', WPDM_TEXT_DOMAIN ); ?></button>
                    <div style="float:left;display: none;" id="fcd" class="text-success"><i class="fa fa-check-circle"></i> <?= esc_attr__( 'File Created', WPDM_TEXT_DOMAIN ); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="__link_settings">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close pull-right" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button>
                    <strong class="modal-title"><?= esc_attr__( 'Update link', WPDM_TEXT_DOMAIN ); ?></strong>
                </div>
                <div class="modal-body">
                    <form id="update_sharelink_form" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
                        ...
                        <div class="text-right">
                            <button type="submit" id="create_sharelink" class="btn btn-info"><?= esc_attr__( 'Update Link', WPDM_TEXT_DOMAIN ); ?></button>
                        </div>
    ...
    <!-- script type="text/v-template" id="wpdmam-pt">
        <form name="fmode">
            <div class="panel panel-default panel-sm">
                <div class="panel-heading">
                    File(s)
                </div>
                <div id="chmod-filelist" class="panel-body">/wpdm.w3eden.com</div>
            </div>
            <table class="table table-stripped chmodtbl text-center" id="chmodtbl" style="margin: 0">
                <tbody><tr>
                    <th class="text-left"><b>Mode</b></th>
                ...
                <tr>
                    <td class="text-left">Read</td>
                    <td><input type="checkbox" class="_pru" name="ur" value="4" onclick="wpdmam_calcperm();"></td>
                    <td><input type="checkbox" class="_prg" name="gr" value="4" onclick="wpdmam_calcperm();"></td>
                    <td><input type="checkbox" class="_prw" name="wr" value="4" onclick="wpdmam_calcperm();"></td>
                </tr>
                <tr>
                    <td class="text-left">Write</td>
                    <td><input type="checkbox" class="_pru" name="uw" value="2" onclick="wpdmam_calcperm();"></td>
                    <td><input type="checkbox" class="_prg" name="gw" value="2" onclick="wpdmam_calcperm();"></td>
                    <td><input type="checkbox" class="_prw" name="ww" value="2" onclick="wpdmam_calcperm();"></td>
                </tr>
                <tr>
                    <td class="text-left">Execute</td>
                    <td><input type="checkbox" class="_pru" name="ux" value="1" onclick="wpdmam_calcperm();"></td>
                    <td><input type="checkbox" class="_prg" name="gx" value="1" onclick="wpdmam_calcperm();"></td>
                    <td><input type="checkbox" class="_prw" name="wx" value="1" onclick="wpdmam_calcperm();"></td>
                </tr>
                <tr>
                    <td class="text-left">Permission</td>
                    <td id="pm-u" class="text-primary">0</td>

                    <td id="pm-g" class="text-primary">0</td>
                    <td id="pm-w" class="text-primary">0</td>
                </tr>
                </tbody></table>
            <br>
...
<script>
    ...
    function updatePerms() {
        var otxt = $('#wpdmam-cfp').html();
        $('#wpdmam-cfp').html("<i class='fa fa-sun fa-spin'></i> <?= esc_attr__( 'Updating...', WPDM_TEXT_DOMAIN ) ?>");
        $.get(ajaxurl, {
            __wpdm_change_fileperms: '<?php echo wp_create_nonce(WPDMAM_NONCE_KEY); ?>',
            action: 'wpdm_changePerms',
            __file: assetSettings.asset.fileEnc,
            __perms: assetSettings.asset.permissions
        }, function (data) {
            $('#wpdmam-cfp').html(otxt);
            WPDM.notify(data.message, 'success');
        });
    }
    ...
    function contentMenu(){
        var $ = jQuery;
        $("#scandir .file-info-area").contextMenu({
            menuSelector: "#contextMenu",
            menuSelected: function (invokedOn, selectedMenu) {
                var action = selectedMenu.data('action');
                switch (action) {
                    case "copy":
                        WPDMAM.copy(invokedOn.data('item'));
                        break;
                    case "cut":
                        WPDMAM.cut(invokedOn.data('item'));
                        break;
                    case "download":
                        var dllink = invokedOn.parent('.row').find('.btn-download').attr('href');
                        if(dllink !== undefined)
                            location.href = dllink;
                        break;
                    case "settings":
                        WPDMAM.assetSettings(invokedOn.data('path'), $('#row_'+invokedOn.data('id')))
                        break;
                    case "delete":
                        WPDMAM.delete(invokedOn.data('path'))
                        break;
                }
            }
        });
    ...
    function wpdmam_calcperm() {
        var _pru = 0, _prg = 0, _prw = 0, $ = jQuery;
        $('._pru').each(function () {
            _pru += $(this).is(':checked') ? parseInt($(this).val()) : 0;
            assetSettings.asset.permissions.user = _pru;
        });
        $('._prg').each(function () {
            _prg += $(this).is(':checked') ? parseInt($(this).val()) : 0;
            assetSettings.asset.permissions.group = _prg;
        });
        $('._prw').each(function () {
            _prw += $(this).is(':checked') ? parseInt($(this).val()) : 0;
            assetSettings.asset.permissions.world = _prw;
        });
    }
    ...
    jQuery(function ($) {
        ...
        $('#btn-featured-assets').on('click', function () {
            refresh_scandir('__featured_assets__');
        });
        ...
        $('body').on('click', '.btn-feature', function (e) {
            e.preventDefault();
            var file_path = $(this).data('path');
            var star = $(this);
            wpdmfm_active_asset = file_path;
            star.find('.fa-star').addClass("fa-spin");
            $.get(ajaxurl, {__wpdm_feature_asset:'<?php echo wp_create_nonce(WPDMAM_NONCE_KEY); ?>', action: 'wpdm_feature_asset', file: file_path }, function (data) {
                 if(data.featured)
        ...
        $('body').on('click', '.btn-settings', function (e) {
            e.preventDefault();
            var file_path = $(this).data('path');
            var row = $('#row_'+$(this).data('id'));
            WPDMAM.assetSettings(file_path, row);
        });
...
<?php if(is_admin()){ ?>
    <script>
        jQuery(function ($) {
            $('[data-simplebar], #cogwin > .panel').css('height', (window.innerHeight - 140)+'px');
            $(window).on('resize', function() {
                $('[data-simplebar], #cogwin > .panel').css('height', (window.innerHeight - 140) + 'px');
                if($('#mainfmarea').is(":fullscreen")){
                    $('[data-simplebar]').css('height', (window.innerHeight - 115) + 'px');
                }
            });
        });
    </script>
